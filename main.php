...
<!--Main weather page - Displays all single location results - set to 'Headcorn' to be shown if none have been selected
...
<div class="container-fluid">
  ...
  //Set to col-xs-3 to allow them to readjust according to the size of the window equally-->
  <div class="row">        
    <div class="container">
      ...
      <div class="panel-group" id="accordion">
        <?php
        //Returns all 5 days in accordion, creating a new panel as a new index and populating for each day.
            ...
            <div id="<?php echo $index; ?>" class="panel-collapse collapse">
              ...
              <div class="panel-body">
                <table class="table table-striped">
                  ...
                  <!--For each table heading, populate with results-->
                  <tbody>
